class LocationsController < ApplicationController
  ...
  def index
    ...
    @locations = Location.order("serial_number ASC").paginate(page: params[:page],:per_page => 7).search(params[:search])
  ...
  def create
    ...
    respond_to do |format|
      if @location.save
        format.html { redirect_to @location, notice: 'Thanks for tracking your card location.' }
